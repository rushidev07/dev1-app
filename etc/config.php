...
return [
    'modules' => [
        ...
        'Ahy_CharityAndDonation' => 1,
        'Ahy_CouponCodeApplication' => 1,
        'Ahy_CspOverride' => 1,
        'Ahy_DeleteElasticsearch' => 1,
        'Ahy_DiscountAlert' => 1,
        'Ahy_Ffl' => 1,
        'Ahy_EstateApiIntegration' => 1,
        'Ahy_EverestNews' => 1,
        'Ahy_EfflApiIntegration' => 1,
        'Ahy_FlxPoint' => 1,
        'Ahy_FlxPointApproval' => 1,
        'Ahy_GooglePay' => 1,
        'Ahy_HidePayPal' => 1,
        'Ahy_Payment' => 1,
        'Ahy_PaymentIntegrations' => 1,
        'Ahy_PermissionMonitor' => 1,
        'Klevu_Logger' => 0,
        'Ahy_ProductExport' => 1,
        'Ahy_Redirect' => 0,
        'Ahy_SavedCC' => 1,
        'FalcoSense_Search' => 1,
        'Ahy_UpdateProductsCSV' => 1,
        'Ahy_Venmo' => 1,
        'Ahy_WebpUpload' => 1,
        ...
        'Amasty_Mostviewed' => 1,
        'Amasty_Promo' => 1,
        'Amasty_PromoGraphql' => 1,
        'Amasty_PromoHyvaCompatibility' => 1,
        'Amasty_Rgrid' => 1,
        'Amasty_SalesRuleWizard' => 1,
        'Attentive_Integration' => 1,
        'BitRail_PaymentGateway' => 1,
        'Magewirephp_Magewire' => 1,
        'Bss_HyvaCompatBase' => 1,
        'Bss_ProductStockAlert' => 1,
        'BubbleHouse_Integration' => 0,
        'DataFeedWatch_Connector' => 1,
        'Ewave_ExtendedBundleProduct' => 1,
        'Klevu_Registry' => 0,
        'Hyva_AmastyFaq' => 1,
        'Hyva_AmastyPromo' => 1,
        'Hyva_BssProductStockAlert' => 1,
        'Hyva_Checkout' => 1,
        'Hyva_CheckoutPayPal' => 1,
        ...
        'Hyva_MageplazaSocialLogin' => 1,
        'Hyva_PageBuilder' => 1,
        'Hyva_PayPalBraintree' => 0,
        'Amasty_BannersLiteHyvaCompatibility' => 1,
        'Hyva_LumaCheckout' => 1,
        ...
        'Klevu_FrontendJs' => 0,
        'Klevu_Content' => 0,
        'Klevu_Categorynavigation' => 0,
        'Ahy_ThemeCustomization' => 1,
        'Ahy_PlpRevamp' => 1,
        'Klevu_Recommendations' => 0,
        'Hyva_KlevuSearch' => 0,
        'Klevu_Addtocart' => 0,
        'Klevu_Troubleshoot' => 0,
        'Hyva_MagecompDiscountpercentage' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_SocialLogin' => 1,
        'Bitrail_HyvaCheckout' => 1,
        'MarkShust_DisableTwoFactorAuth' => 0,
        'Monsoon_HyvaAjaxAddToCart' => 1,
        'OuterEdge_StructuredData' => 1,
        'Webkul_MpMultiShipping' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Printful_Integration' => 0,
        ...
        'Webkul_MpApi' => 1,
        'Ahy_CatalogPerfFix' => 1,
        'Webkul_MpFixedRateshipping' => 1,
