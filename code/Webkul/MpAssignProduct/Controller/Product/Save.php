...
class Save extends \Magento\Framework\App\Action\Action
{
   ...
   * @param \Webkul\MpAssignProduct\Model\Items $assignedModel
   */
    public function __construct(
        ...
        \Webkul\MpAssignProduct\Model\ItemsFactory $assignedModel
    ) {
    ...
    public function execute()
    {
        ...
        if (array_key_exists('assign_id', $data)) {
            $assignIds = $this->getAssignId($data['assign_id'], $helper->getCustomerId());
            if (!$assignIds) {
    ...
    */
    ...
    {
        $model = $this->assignedModel->create()->load($assign_id);
