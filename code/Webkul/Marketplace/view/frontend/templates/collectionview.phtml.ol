            ...
            <div class="wk-mp-collection-right">
                ...
                <?php if ($_productCollection->count()) { echo 'style="padding: 0;"';}?>>
                    ...
                    <?php if (!$_productCollection->count()): ?>
                        <div class="message info empty"><div><?= /* @escapeNotVerified */
                        $escaper->escapeHtml(__('We can\'t find products matching the selection.')) ?></div></div>
                    <?php else: ?>
                                            ...
                                            <div class="product-item-inner">
                                                        ...
                                                        <?php if ($_product->isSaleable()): ?>
                                                            ...
                                                            method="post">
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    <span><?= $escaper
                                                                    ->escapeHtml(__('Add to Cart')) ?></span>
                                                                </button>
                                                            </form>
                                                        <?php else: ?>
                                                ...
                                                <?php if ($showDescription):?>
                                                    <div class="product description product-item-description">
                                                        ...
                                                        class="action more"><?= $escaper
                                                        ->escapeHtml(__('Learn More')) ?></a>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
