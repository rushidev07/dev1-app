...
class Matrix extends \Magento\Framework\View\Element\Template
{
            ...
            if (isset($productData['configurable_attributes_data'])) {
                ...
                foreach ($confAttributes as $key => $confAttribute) {
                    if (isset($configurableAttributeData[$key])) {
                        ...
                        $confAttributes[$key]['values'] = $this->arrayMergeFunction(
     ...
     * @return array
     */
    protected function arrayMergeFunction($arr1, $arr2)
    {
    ...
    /**
     * Get onfigurable assocaited products attribute
     *
     * @return array
     */
    ...
    /**
     * Get sellerr products attribute
     *
     * @return array|null
     */
    ...
    /**
     * Get configurble prouct variation
     *
     * @return array
     */
        ...
        if ($configurableProductVariations) {
            ...
            foreach ($configurableProductVariations as $configurableProductVariation) {
                ...
                if (isset($productByUsedAttributes[$key])) {
                    ...
                    // $configurableProductMatrix = $this->getConfigurableProductMatrixData(
                    //     $configurableProductMatrix,
                    //     $product,
                    ...
                    //     $configurableProductVariation
                    // );
                    list($confAttributes, $configurableProductMatrix) = $this->getConfigurableProductMatrixData(
                        $configurableProductMatrix,
                        $product,
                        $usedProductAttributes,
                        $confAttributes,
     ...
     * Get configurble prouct variation
     *
     * @param array $configurableProductMatrix
     * @param \Magento\Catalog\Model\Product $product
     * @param array $usedProductAttributes
     * @param array $confAttributes
     * @param array $configurableProductVariation
     * @return array
     */
    protected function getConfigurableProductMatrixData(
        $configurableProductMatrix,
        $product,
        $usedProductAttributes,
        $confAttributes,
        ...
        return [$confAttributes, $configurableProductMatrix];
    }
}
