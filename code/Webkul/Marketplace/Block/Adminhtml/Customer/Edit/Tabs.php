...
class Tabs extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
        ...
        if ($partner['seller_active'] == 1) {
            $sellerActive = "value='1' checked='checked'";
        }
        ...
        $fieldset->addField(
            ...
            'text',
            [
                'name' => 'flxPoint_seller_id',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('FlxPoint Seller ID'),
                'title' => __('FlxPoint Seller ID'),
                'value' => $partner['flxPoint_seller_id'],
                'after_element_html' => '<input
                    type="checkbox"
                    name="seller_active"
                    data-form-part="customer_form"
                    onchange="this.value = this.checked ? 1 : 0;"
                    title="'.__('Is seller Active?').'"
                    '.$sellerActive.'
                >',
            ]
        );
