...
namespace Webkul\MpSellerBuyerCommunication\Model\ResourceModel\SellerBuyerCommunication\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\MpSellerBuyerCommunication\Model\ResourceModel\SellerBuyerCommunication\Collection as
    SellerCollection;
...
/**
 * Webkul\MpSellerBuyerCommunication\Model\ResourceModel\SellerBuyerCommunication\Grid\Collection Class
 * Collection for displaying grid of seller buyer communication.
 */
class Collection extends SellerCollection implements ApiSearchResultInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->join(
            $joinTable.' as cgf',
            'main_table.seller_id = cgf.entity_id AND main_table.seller_id > 0 OR main_table.seller_id = 0',
            ['seller_name' => 'IF(main_table.seller_id = 0 , "Administrator",cgf.name)']
        )
