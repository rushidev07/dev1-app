 ...
 */
class MailToAdmin implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        if (!isset($args['query']) || !isset($args['subject'])) {
            throw new GraphQlInputException(
                __("'query' & 'subject' input arguments are required.")
            );
        }
        $result = $this->sellerManagement->mailToAdmin($context->getUserId(), $args["subject"], $args["query"]);
