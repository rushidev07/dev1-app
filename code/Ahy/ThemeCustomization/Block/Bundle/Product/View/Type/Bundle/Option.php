<?php
namespace Ahy\ThemeCustomization\Block\Bundle\Product\View\Type\Bundle;

use Magento\Catalog\Model\Product;
use Magento\Bundle\Block\Catalog\Product\View\Type\Bundle\Option as ParentOption;
...
class Option extends ParentOption
{
    ...
    public function getSelectionQtyTitlePrice($selection, $includeContainer = true)
    {
        ...
        $priceTitle = '<span class="product-name">'
            ...
            . '</span>';
        $productType = $selection->getTypeId();
        // Add custom message before the price of the selected simple product
        if($productType === "simple"){
            $priceTitle .= '<span class="custom-message">Custom message before price</span> &nbsp; ' 
                . ($includeContainer ? '<span class="price-notice">' : '') 
                . '+' . $this->renderPriceString($selection, $includeContainer) 
