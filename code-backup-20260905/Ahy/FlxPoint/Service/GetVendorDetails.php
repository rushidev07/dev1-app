...
class GetVendorDetails {
    ...
    const API_VENDORS_REQUEST_ENDPOINT = 'vendors/';
    ...
    public function getVendor(){
        $vendorApi = self::API_VENDORS_REQUEST_ENDPOINT;
        $params = [
            'headers' => [
    ...
    private function _doRequest( string  $uriEndpoint,  string  $requestMethod,  array   $params = [] ): Response {
        ...
        try {
            ...
            $this->_flxPointApiLogger->info( ' In catch ' . ' <pre> ' . $exception->getMessage() . ' from Ahy\FlxPoint\Service\GetVendorDetails');
        }
        return $response ;
    }
