 ...
 */
class GetShipmentDetails implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        if (!isset($args['orderId']) || !isset($args['shipmentId'])) {
            throw new GraphQlInputException(
                __("'orderId' & 'shipmentId' input arguments are required.")
            );
        }
        $result = $this->sellerManagement->viewShipment(
            $context->getUserId(),
            $args['orderId'],
            $args['shipmentId']
        );
