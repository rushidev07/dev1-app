...
class Delete extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $assignedModel = $this->_items->create()->load($assignId);
        if ($assignedModel->getSellerId() != $helper->getCustomerId()) {
            $this->messageManager->addError(__('Product is not assigned to you'));
