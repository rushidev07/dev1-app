...
class Collection extends AbstractCollection
{
    ...
    protected function _getAllIdsSelect($limit = null, $offset = null)
    {
        ...
        $idSelect->reset(\Magento\Framework\DB\Select::ORDER);
        $idSelect->reset(\Magento\Framework\DB\Select::LIMIT_COUNT);
        $idSelect->reset(\Magento\Framework\DB\Select::LIMIT_OFFSET);
        $idSelect->reset(\Magento\Framework\DB\Select::COLUMNS);
        $idSelect->columns($this->getResource()->getIdFieldName(), 'main_table');
