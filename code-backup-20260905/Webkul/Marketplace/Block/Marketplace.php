...
class Marketplace extends \Magento\Framework\View\Element\Template
{
    ...
    public function getBestSaleSellers()
    {
        ...
        if (count($sellerArr) != 4) {
            ...
            foreach ($countProArr as $procountSellerId => $procount) {
                if ($i <= 4) {
                    $sellerArrData = $this->getSellerIdArrayMethod(
                        $sellerArr,
                        $sellerCountArr,
                        $sellerIdsArr,
                    ...
                    $sellerArr = $sellerArrData['seller_arr'];
                    $sellerCountArr = $sellerArrData['seller_count_arr'];
                    $sellerIdsArr = $sellerArrData['seller_ids_arr'];
                }
                ++$i;
            }
        }
    ...
    /**
     * Get Seller Id Array Method
     *
     * @param array $sellerArr
     * @param array $sellerCountArr
     * @param array $sellerIdsArr
     * @param string $catalogProductWebsite
     * @param string $marketplaceProduct
     * @param int $storeId
     * @param int $procountSellerId
     * @param int $procount
     * @return array
     */
    public function getSellerIdArrayMethod(
        $sellerArr,
        $sellerCountArr,
        $sellerIdsArr,
        $catalogProductWebsite,
        ...
        return [
            'seller_arr' => $sellerArr,
            'seller_count_arr' => $sellerCountArr,
            'seller_ids_arr' => $sellerIdsArr,
        ];
    }
