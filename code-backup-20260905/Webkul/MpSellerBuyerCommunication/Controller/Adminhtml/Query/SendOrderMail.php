    ...
    */
    ...
    public function execute()
    {
        ...
        if ($validSeller) {
            ...
            $ask = $this->helper->removeScriptFromData($data['ask']);
            ...
            $status = $this->helper->checkQueryAutoApprovalStatus();
            if (!$status) {
                $status = 0;
            }
            ...
            if ($status) {
                ...
                $this->emailHelper->sendOrderQueryEmailToCustomerFromAdmin(
                    $data,
                    $emailTemplateVariables,
                    $senderInfo,
                    $receiverInfo
