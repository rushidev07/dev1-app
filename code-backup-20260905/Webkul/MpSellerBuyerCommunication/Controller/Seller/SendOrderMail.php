    ...
    public function execute()
    {
        ...
        if ($validSeller) {
            ...
            if ($this->_helper->getAdminNotificationStatus() && $data['seller-id'] > 0) {
                ...
                $emailTemplateVariables['myvar7'] =$sellerName;
                $emailTemplateVariables['myvar8'] =$sellerEmail;
                $senderInfo = [
                    'name' => $sellerName,
                    'email' => $sellerEmail,
                ];
                ...
                $this->emailHelper->sendOrderQuerypartnerEmailToAdmin(
                    $data,
                    $emailTemplateVariables,
                    $senderInfo,
                    $receiverInfo
